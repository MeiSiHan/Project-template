...
# 安装rollup
npm install rollup @rollup/plugin-babel @rollup/plugin-node-resolve rollup-plugin-terser rollup-plugin-postcss @rollup-plugin-commonjs @rollup/plugin-typescrip --save-dev
